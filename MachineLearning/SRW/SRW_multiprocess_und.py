...
from SRW_mp_helper_KB_und import * 
import queue 
...
def main():
    ...
    off_dy1_vals = np.zeros(n_runs) #np.random.uniform(zx_min, zx_max, n_runs)
    off_dx2_vals = np.zeros(n_runs) #np.random.uniform(zx_min, zx_max, n_runs)
    ...
    varParam = get_reset_varParam()
    hOffsetIdx = varparam_idxs(varParam, ['op_M1_x', 'f', 0.0, 'horizontalOffset']) ### mirror 1 horizontal
    vOffsetIdx = varparam_idxs(varParam, ['op_M1_y', 'f', 0.0, 'verticalOffset']) 
    hOffsetIdx2 = varparam_idxs(varParam, ['op_M2_x', 'f', 0.0, 'horizontalOffset']) ### mirror 1 horizontal
    vOffsetIdx2 = varparam_idxs(varParam,['op_M2_y', 'f', 0.0, 'verticalOffset'])  ### mirror 2 vertical 
    nvx_idx = varparam_idxs(varParam, ['op_M1_nvx', 'f', 0.999389625362475, 'normalVectorX'])
    nvy_idx = varparam_idxs(varParam, ['op_M1_nvy', 'f', 0.0, 'normalVectorY'])
    nvz_idx = varparam_idxs(varParam, ['op_M1_nvz', 'f', -0.03493389067727645, 'normalVectorZ'])
    nvx2_idx = varparam_idxs(varParam, ['op_M2_nvx', 'f', 0.0, 'normalVectorX'])
    nvy2_idx = varparam_idxs(varParam, ['op_M2_nvy', 'f', 0.999389625362475, 'normalVectorY'])
    nvz2_idx = varparam_idxs(varParam, ['op_M2_nvz', 'f', -0.03493389067727645, 'normalVectorZ'])
    ...
    wp_idx = varparam_idxs(varParam, ['op_M2_Watchpoint_L', 'f', 8.0, 'length'])
