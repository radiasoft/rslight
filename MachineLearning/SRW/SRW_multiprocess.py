...
def main():
    ...
    varParam = get_reset_varParam()
    hOffsetIdx = varparam_idxs(varParam, ['op_Elliptical_Cylinder_x', 'f', 0.0, 'horizontalOffset']) ### mirror 1 horizontal
    vOffsetIdx = varparam_idxs(varParam, ['op_Elliptical_Cylinder_y', 'f', 0.0, 'verticalOffset']) 
    hOffsetIdx2 = varparam_idxs(varParam, ['op_Elliptical_Cylinder2_x', 'f', 0.0, 'horizontalOffset']) ### mirror 1 horizontal
    vOffsetIdx2 = varparam_idxs(varParam,['op_Elliptical_Cylinder2_y', 'f', 0.0, 'verticalOffset'])  ### mirror 2 vertical 
    ...
    nvx2_idx = varparam_idxs(varParam, ['op_Elliptical_Cylinder2_nvx', 'f', 0.0, 'normalVectorX'])
    nvy2_idx = varparam_idxs(varParam, ['op_Elliptical_Cylinder2_nvy', 'f', 0.999389625362475, 'normalVectorY'])
    nvz2_idx = varparam_idxs(varParam, ['op_Elliptical_Cylinder2_nvz', 'f', -0.03493389067727645, 'normalVectorZ'])
    ...
    wp_idx = varparam_idxs(varParam, ['op_Elliptical_Cylinder2_Watchpoint_L', 'f', 8.0, 'length'])
